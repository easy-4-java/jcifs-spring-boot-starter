...
**jcifs-spring-boot-starter** is a Spring Boot starter that integrates **jcifs** for applications using jcifs. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume jcifs capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using jcifs |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for jcifs |
| JDK | `17` |
| Coordinates | `io.github.easy4j:jcifs-spring-boot-starter:1.0.0-SNAPSHOT` |
| Config Prefix | `jcifs` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers jcifs beans automatically |
